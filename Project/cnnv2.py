...
model = Sequential()
#input conv layer 
model.add(Conv2D(32, (3, 3), activation='relu', name='conv1', padding='same', input_shape=(64, 64, 3)))
#hidden conv layer
...
#CNN trainieren
model.fit_generator(train_generator,steps_per_epoch=200000, epochs=100, validation_data=val_generator,
          verbose=1, callbacks=[EarlyStopping(monitor='valloss',min_delta=0, patience=3),
        ModelCheckpoint(filepath='/informatik2/students/home/7dill/Desktop/CV/Project/cnn2weights.h5', monitor='val_loss', verbose=0, save_best_only=True, save_weights_only=False, mode='auto', period=1)])
